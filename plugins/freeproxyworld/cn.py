...
def run():
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        for _ in range(max_workers):
            ...
            futures.add(executor.submit(fetch_proxies, country="CN", page=current_page))
            current_page += 1
                ...
                try:
                    ...
                    if not page_results:
                        ...
                        if not hit_end and (
                            ...
                            futures.add(
                                executor.submit(
                                    fetch_proxies, country="CN", page=current_page
                                )
                            )
                            current_page += 1
    ...
    # 导出
    fd, path = tempfile.mkstemp(suffix=".json", prefix="freeproxyworld-cn-")
